 ...
 *
 */
@WebServiceClient(name = "dmOperationsWebService", targetNamespace = "http://isds.czechpoint.cz/v20", wsdlLocation = "file:/D:/data.gov.cz/isds-adapt\u00e9r/src/main/resources/wsdl/dm_operations.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/data.gov.cz/isds-adapt\u00e9r/src/main/resources/wsdl/dm_operations.wsdl");
