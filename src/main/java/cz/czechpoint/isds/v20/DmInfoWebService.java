 ...
 *
 */
@WebServiceClient(name = "dmInfoWebService", targetNamespace = "http://isds.czechpoint.cz/v20", wsdlLocation = "https://www.mojedatovaschranka.cz/static/wsdl/v20/dm_info.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://www.mojedatovaschranka.cz/static/wsdl/v20/dm_info.wsdl");
